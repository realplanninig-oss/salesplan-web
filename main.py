# File: main.py — веб-приложение Salesplan (неоновая тема, стеклянные блоки)
...
# === ГЛОБАЛЬНЫЕ HTML ШАБЛОНЫ И CSS (НЕОНОВАЯ ТЕМА, СТЕКЛЯННЫЙ ЭФФЕКТ) ===
...
<head>
    ...
    <style>
        /* ГЛОБАЛЬНЫЕ СТИЛИ – НЕОНОВАЯ ТЕМА, СТЕКЛЯННЫЙ ЭФФЕКТ */
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .hero h1{font-size:52px;font-weight:700;margin-bottom:20px;letter-spacing:-0.02em;color:#B5FF47;text-shadow:0 0 20px rgba(181,255,71,0.3)}
        .hero p{font-size:21px;color:#aab2c0;max-width:700px;margin-left:auto;margin-right:auto}
        h1, h2, h3, .heading { color: #B5FF47; }
        h2 { font-size: 36px; font-weight: 700; margin-bottom: 16px; text-shadow: 0 0 20px rgba(181,255,71,0.2); }
        h3 { font-size: 24px; font-weight: 600; margin-bottom: 12px; }
        .btn-main{display:inline-block;background:#B5FF47;color:#0F1115;text-decoration:none;padding:16px 48px;font-size:20px;font-weight:600;border-radius:48px;box-shadow:0 0 20px rgba(181,255,71,0.3);transition:transform 0.2s,box-shadow 0.2s;border:none;cursor:pointer}
        .btn-main:hover{background:#a3e63a;transform:scale(1.02);box-shadow:0 0 30px rgba(181,255,71,0.5)}
        .btn-secondary{background:transparent;border:1px solid #B5FF47;color:#B5FF47}
        .btn-secondary:hover{background:#B5FF47;color:#0F1115}
        ...
        .glass-card:hover{border-color:rgba(181,255,71,0.3);box-shadow:0 8px 32px rgba(181,255,71,0.1)}
        ...
        .social-links a{color:#B5FF47;text-decoration:none;font-size:12px}
        ...
        input:focus,textarea:focus{outline:none;border-color:#B5FF47;box-shadow:0 0 15px rgba(181,255,71,0.2)}
        ...
        .radio-group label:hover{background:rgba(181,255,71,0.1);border-color:rgba(181,255,71,0.3)}
        .radio-group input[type="radio"]{width:20px;height:20px;margin:0;cursor:pointer;accent-color:#B5FF47}
        ...
        .step-card:hover{transform:translateY(-4px);border-color:rgba(181,255,71,0.3);box-shadow:0 8px 25px rgba(181,255,71,0.1)}
        ...
        .timeline-point .dot{width:12px;height:12px;border-radius:50%;background:#B5FF47;border:2px solid #0F1115;box-shadow:0 0 10px rgba(181,255,71,0.3)}
...
HTML_FOOT = """
    <div class="footer">
        ...
        <div style="margin-top: 8px;">
            <a href="/oferta" style="color:#B5FF47;text-decoration:none;">Публичная оферта</a> | <a href="/privacy" style="color:#B5FF47;text-decoration:none;">Политика персональных данных</a>
        </div>
...
<body><div class="spinner"></div><h1 style="color:#B5FF47;">Генерируем ваш план...</h1><p style="color:#8e8e93;">Это займёт 1-2 минуты. Страница обновится сама.</p></body>
</html>"""

# ========================================
# ГЛАВНАЯ СТРАНИЦА (неоновая тема, стекло)
# ========================================
@app.get("/")
async def index():
    content = '''
<style>
    ...
    .apple-hero h1 {
        ...
        margin-bottom: 8px;
        color: #B5FF47;
        text-shadow: 0 0 30px rgba(181,255,71,0.3);
    }
    .apple-hero .subtitle {
        font-size: 20px;
        font-weight: 400;
    ...
    .apple-text-block strong { font-weight: 600; color: #B5FF47; }
    .apple-list {
        list-style: none;
        padding: 0;
        margin: 20px 0 24px;
    ...
    .step-card:hover { transform: translateY(-4px); border-color: rgba(181,255,71,0.3); box-shadow: 0 8px 25px rgba(181,255,71,0.1); }
    .step-icon { font-size: 40px; display: block; margin-bottom: 12px; }
    .step-title { font-size: 18px; font-weight: 600; color: #B5FF47; margin-bottom: 8px; }
    ...
    .what-list li {
        ...
        background: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="%23B5FF47" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>') left center no-repeat;
        background-size: 20px;
        color: #f5f5f7;
        font-size: 16px;
    ...
    .timeline-point .dot {
        ...
        box-shadow: 0 0 10px rgba(181,255,71,0.3);
    }
    .timeline-point .dot.done { background: #ff9f0a; box-shadow: 0 0 10px rgba(255,159,10,0.3); }
    ...
    .badge-metrics strong { color: #B5FF47; }
    @media (max-width: 700px) {
...
<div class="apple-hero">
    ...
    <div class="apple-text-block">
        ...
        <p style="font-size: 19px; font-weight: 500; color: #fff;">Заполните 5 полей – и я пришлю вам персональный план.</p>
    </div>
...
<div style="margin: 80px 0; text-align: center;">
    <h2 style="color: #B5FF47; text-shadow: 0 0 20px rgba(181,255,71,0.2);">Как вы получите заявки за 14 дней</h2>
...
<div style="margin: 80px 0; text-align: center;">
    <h2 style="color: #B5FF47; text-shadow: 0 0 20px rgba(181,255,71,0.2);">Что получите уже сегодня</h2>
    ...
    <div class="what-grid">
        ...
        <div style="background: rgba(26,29,35,0.3); backdrop-filter: blur(8px); border-radius: 20px; padding: 24px; border: 1px solid rgba(255,255,255,0.06);">
            <h4 style="color: #B5FF47; font-size: 16px; margin-bottom: 8px;">Временная шкала внедрения</h4>
            <div class="timeline">
...
<div style="margin: 80px 0;">
    <h2 style="color: #B5FF47; text-shadow: 0 0 20px rgba(181,255,71,0.2); text-align: center; margin-bottom: 40px;">Частые вопросы</h2>
...
<div style="background:rgba(26,29,35,0.5); backdrop-filter:blur(12px); border-radius:28px; padding:24px; margin-top:20px; text-align:center; border:1px solid rgba(255,255,255,0.06);">
    <h1 style="color:#B5FF47; text-shadow: 0 0 20px rgba(181,255,71,0.2);">Спасибо за заявку!</h1>
...
<div style="text-align:center; max-width:600px; margin:0 auto;">
    <p style="font-size:20px; font-weight:600; color:#B5FF47;">Хотите, чтобы я внедрил этот план и привёл вам клиентов?</p>
    <p style="font-size:16px; color:#8e8e93; margin:16px 0;">
    ...
    <div style="margin-top:16px;">
        <a href="/" class="btn-main" style="background:transparent; color:#B5FF47; box-shadow:none; border:1px solid #B5FF47;">Вернуться на главную</a>
    </div>
</div>
'''
    return HTMLResponse(content=render_page(content))
...
<div style="max-width:700px; margin:0 auto; padding:20px 16px;">
    ...
    <div class="glass-card" style="text-align:center; margin-bottom:24px;">
        <h3 style="color:#B5FF47; text-shadow: 0 0 15px rgba(181,255,71,0.2);">Результаты, на которых обучен мой AI-аналитик</h3>
        <div style="display:flex; justify-content:space-around; flex-wrap:wrap; gap:12px;">
            <div>
                <div style="font-weight:700; font-size:24px; color:#B5FF47; text-shadow: 0 0 15px rgba(181,255,71,0.2);">+120 000 ₽</div>
                <div style="font-size:14px; color:#8e8e93;">без блога</div>
            </div>
            <div>
                <div style="font-weight:700; font-size:24px; color:#B5FF47; text-shadow: 0 0 15px rgba(181,255,71,0.2);">+187 000 ₽</div>
                <div style="font-size:14px; color:#8e8e93;">с вебинара</div>
            </div>
            <div>
                <div style="font-weight:700; font-size:24px; color:#B5FF47; text-shadow: 0 0 15px rgba(181,255,71,0.2);">+2 000 000 ₽</div>
    ...
    <div style="background:rgba(0,0,0,0.3); border-radius:16px; padding:16px; margin-bottom:24px; text-align:center; border:1px solid rgba(255,255,255,0.06);">
        <p style="font-size:16px; color:#f5f5f7; margin-bottom:12px;">
            <strong style="color:#B5FF47;">Не уверены, что выбрать?</strong><br>
    ...
    <h1 style="font-size:28px; font-weight:700; text-align:center; margin-bottom:8px; color:#B5FF47; text-shadow: 0 0 20px rgba(181,255,71,0.2);">Вы получили план. Теперь выберите, как мы будем работать с ним дальше.</h1>
    ...
    <div class="glass-card" style="margin-bottom:16px;">
        <div style="display:flex; align-items:center; gap:12px; margin-bottom:12px;">
            ...
            <h2 style="font-size:22px; font-weight:600; margin:0; color:#B5FF47;">Я проверю ваш план</h2>
        </div>
    ...
    <div class="glass-card" style="border-color:rgba(181,255,71,0.3); margin-bottom:16px;">
        <div style="display:flex; align-items:center; gap:12px; margin-bottom:12px;">
            <span style="font-size:28px;">&#128196;</span>
            <h2 style="font-size:22px; font-weight:600; margin:0; color:#B5FF47;">Расширенный план</h2>
        </div>
        <p style="font-size:15px; color:#f5f5f7; margin-bottom:12px; line-height:1.5;">
        ...
        <p style="font-size:14px; color:#8e8e93; margin-bottom:16px;">
            <strong style="color:#B5FF47;">Цена:</strong> 2 500 ₽
        </p>
        <a href="{payment_link_2500}" class="btn-main" style="display:block; text-align:center; background:#B5FF47; box-shadow:0 0 20px rgba(181,255,71,0.3); padding:14px 24px; font-size:17px; border-radius:48px; text-decoration:none; color:#0F1115;" onclick="ym(108348240,'reachGoal','choose_paid'); return true;">
            Оплатить 2 500 ₽
        </a>
    </div>
    ...
    <div class="glass-card gold" style="margin-bottom:16px;">
        <div style="display:flex; align-items:center; gap:12px; margin-bottom:12px;">
            <span style="font-size:28px;">&#128640;</span>
            <h2 style="font-size:22px; font-weight:600; margin:0; color:#B5FF47;">Внедрение под ключ</h2>
        </div>
        <p style="font-size:15px; color:#f5f5f7; margin-bottom:12px; line-height:1.5;">
            Я лично внедряю систему: аудит, настройка воронки, запуск рекламы, скрипты, отчёты.
        </p>
        <p style="font-size:15px; color:#f5f5f7; margin-bottom:8px;">
            <strong style="color:#B5FF47;">Результат:</strong> первые заявки через 14 дней.
        </p>
        <p style="font-size:15px; color:#f5f5f7; margin-bottom:16px;">
            <strong style="color:#B5FF47;">Гарантия:</strong> если за 14 дней не будет ни одной заявки – я <strong style="color:#B5FF47;">возвращаю деньги</strong> или продолжаю работу до первого клиента бесплатно (на ваш выбор).
        </p>
        <p style="font-size:14px; color:#8e8e93; margin-bottom:16px;">
            <strong style="color:#B5FF47;">Цена:</strong> 14 900 ₽
        </p>
    ...
    <p style="font-size:14px; color:#636366; text-align:center; margin-top:24px;">
        Есть вопросы? <a href="{channel_link}" target="_blank" style="color:#B5FF47; text-decoration:none;">Напишите мне в MAX</a>
    </p>
</div>
'''
    return HTMLResponse(content=render_page(content))
...
async def payment_page(user_id: str, amount: int = 2500):
    ...
    content = f'''
<div class="hero">
    <h1 style="color:#B5FF47; text-shadow: 0 0 20px rgba(181,255,71,0.2);">{title}</h1>
...
async def payment_success(user_id: str, amount: int = 2500):
    ...
    <div style="background:rgba(26,29,35,0.5); border-radius:16px; padding:16px; border:1px solid #ff9f0a;">
        <p style="font-size:15px; color:#f5f5f7;"><strong style="color:#ff9f0a;">Гарантия для тарифа "Внедрение под ключ":</strong> если через 14 дней у вас не будет ни одной новой заявки – я <strong style="color:#ff9f0a;">возвращаю деньги</strong> или продолжаю работу до первого клиента бесплатно (на ваш выбор).</p>
    </div>
    """
...
<div class="form-card" style="text-align:center;">
    ...
    <div style="background:rgba(26,29,35,0.5); border-radius:24px; padding:24px; text-align:center; border:1px solid rgba(255,255,255,0.06);">
        <h3 style="color:#B5FF47;">Бесплатный разбор плана от продюсера</h3>
    ...
    <div style="background:rgba(0,0,0,0.3); border-radius:20px; padding:20px; margin-top:20px; border:1px solid rgba(255,255,255,0.06);">
        <p style="font-size:14px; color:#8e8e93;">Если у вас возникли вопросы, напишите мне в личный чат MAX: <a href="https://max.ru/u/f9LHodD0cOJKjwAZrG-GC6z1VP02b4BrBEFVlrA1G9pu874eZzgdwHZnKV8" target="_blank" style="color:#B5FF47; text-decoration:none;">открыть чат</a></p>
    </div>
</div>
'''
...
<div class="hero" style="margin-bottom:30px;">
    <h1 style="font-size:36px; color:#B5FF47; text-shadow: 0 0 20px rgba(181,255,71,0.2);">Разговор по делу – 20 минут</h1>
    <p style="font-size:18px; color:#8e8e93; max-width:700px; margin:0 auto;">
    ...
    <p style="font-size:15px; color:#636366; max-width:700px; margin:0 auto; margin-top:10px;">
...
<div class="form-card" style="text-align:center; max-width:600px; margin:0 auto;">
    <div style="background:rgba(0,0,0,0.3); border-radius:16px; padding:20px; margin-bottom:24px; text-align:left; border:1px solid rgba(255,255,255,0.06);">
        <p style="font-size:16px; line-height:1.5; margin:0; color:#f5f5f7;">
            <strong style="color:#B5FF47;">Что вы получите за 20 минут:</strong><br>
    ...
    <p style="font-size:14px; color:#636366; margin-top:10px;">
        Напишите цифру <strong style="color:#B5FF47;">1</strong> в чат – и я вышлю вам разбор.
    </p>
...
async def implementation_page(user_id: str = None):
    ...
    content = f'''
<div class="hero">
    <h1 style="color:#B5FF47; text-shadow: 0 0 20px rgba(181,255,71,0.2);">Внедрение под ключ – ваш бизнес с системой за 14 дней</h1>
...
<div class="form-card" style="max-width:700px; text-align:left; margin:0 auto;">
    <h3 style="color:#B5FF47;">Что входит:</h3>
    ...
    <div style="background:rgba(0,0,0,0.3); border-radius:16px; padding:16px; margin:24px 0; border:1px solid rgba(255,255,255,0.06);">
        <p style="font-size:18px; font-weight:600; text-align:center; color:#B5FF47;">Цена: от 15 000 ₽</p>
...
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Админ-дашборд | Salesplan</title><script src="https://cdn.jsdelivr.net/npm/chart.js"></script><style>
        *{margin:0;padding:0;box-sizing:border-box} body{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;background:#0F1115;color:#f5f5f7;padding:20px}
        .container{max-width:1400px;margin:0 auto} h1{color:#B5FF47;font-size:28px;margin-bottom:20px;text-shadow:0 0 20px rgba(181,255,71,0.2)}
        ...
        .stat-card .value{font-size:32px;font-weight:700;color:#B5FF47;text-shadow:0 0 15px rgba(181,255,71,0.2)}
        ...
        .funnel-step .step-count{width:100px;font-size:24px;font-weight:700;color:#B5FF47}
        .funnel-step .step-bar{flex:1;height:30px;background:rgba(255,255,255,0.06);border-radius:15px;overflow:hidden}
        .funnel-step .step-fill{height:100%;background:#B5FF47;border-radius:15px;display:flex;align-items:center;justify-content:flex-end;padding-right:10px;color:#0F1115;font-size:12px}
...
const steps=[[{name:'Посетители сайта',key:'visitors',color:'#B5FF47'},{name:'Бесплатная диагностика',key:'diagnostics',color:'#5856d6'},{name:'Оплата плана (2500₽)',key:'payments',color:'#ff9f0a'},{name:'Скачивание отчета',key:'downloads',color:'#34c759'}]];
...
<div class="hero" style="margin-bottom:20px;">
    <h1 style="color:#B5FF47; text-shadow: 0 0 20px rgba(181,255,71,0.2);">Публичная оферта</h1>
...
<div class="glass-card" style="text-align:left;max-width:800px;margin:0 auto;">
    <p><strong style="color:#B5FF47;">Индивидуальный предприниматель Макаревич Вероника Александровна,</strong><br>
    ...
    <h3 style="color:#B5FF47;">1. ТЕРМИНЫ И ОПРЕДЕЛЕНИЯ</h3>
    ...
    <h3 style="color:#B5FF47;">2. ПРЕДМЕТ ДОГОВОРА</h3>
    ...
    <h3 style="color:#B5FF47;">3. СТОИМОСТЬ И ПОРЯДОК ОПЛАТЫ</h3>
    ...
    <h3 style="color:#B5FF47;">4. ПОРЯДОК ПЕРЕДАЧИ ЦИФРОВОГО ТОВАРА</h3>
    ...
    <h3 style="color:#B5FF47;">5. ПОРЯДОК ВОЗВРАТА ДЕНЕЖНЫХ СРЕДСТВ</h3>
    ...
    <h3 style="color:#B5FF47;">6. ОТВЕТСТВЕННОСТЬ СТОРОН</h3>
    ...
    <h3 style="color:#B5FF47;">7. ИНТЕЛЛЕКТУАЛЬНАЯ СОБСТВЕННОСТЬ</h3>
    ...
    <h3 style="color:#B5FF47;">8. ПЕРСОНАЛЬНЫЕ ДАННЫЕ И КОНФИДЕНЦИАЛЬНОСТЬ</h3>
    ...
    <h3 style="color:#B5FF47;">9. ФОРС-МАЖОР</h3>
    ...
    <h3 style="color:#B5FF47;">10. КОНТАКТЫ ПРОДАВЦА</h3>
    ...
    <h3 style="color:#B5FF47;">11. ЗАКЛЮЧИТЕЛЬНЫЕ ПОЛОЖЕНИЯ</h3>
...
async def privacy_page():
    content = """
<div class="hero" style="margin-bottom:20px;">
    <h1 style="color:#B5FF47; text-shadow: 0 0 20px rgba(181,255,71,0.2);">Политика обработки персональных данных</h1>
    <p style="font-size:14px; color:#8e8e93;">Индивидуального предпринимателя Макаревич Вероники Александровны</p>
</div>
<div class="glass-card" style="text-align:left;max-width:800px;margin:0 auto;">
    <h3 style="color:#B5FF47;">1. ОБЩИЕ ПОЛОЖЕНИЯ</h3>
    ...
    <h3 style="color:#B5FF47;">2. КАКИЕ ДАННЫЕ СОБИРАЮТСЯ</h3>
    ...
    <h3 style="color:#B5FF47;">3. ЦЕЛИ ОБРАБОТКИ ПЕРСОНАЛЬНЫХ ДАННЫХ</h3>
    ...
    <h3 style="color:#B5FF47;">4. ПРАВОВЫЕ ОСНОВАНИЯ ОБРАБОТКИ</h3>
    ...
    <h3 style="color:#B5FF47;">5. ПОРЯДОК И УСЛОВИЯ ОБРАБОТКИ</h3>
    ...
    <h3 style="color:#B5FF47;">6. ПРАВА ПОЛЬЗОВАТЕЛЯ</h3>
    ...
    <h3 style="color:#B5FF47;">7. ЗАЩИТА ПЕРСОНАЛЬНЫХ ДАННЫХ</h3>
    ...
    <h3 style="color:#B5FF47;">8. ИСПОЛЬЗОВАНИЕ ФАЙЛОВ COOKIE И МЕТРИК</h3>
    ...
    <h3 style="color:#B5FF47;">9. ПОРЯДОК ОТЗЫВА СОГЛАСИЯ</h3>
    ...
    <h3 style="color:#B5FF47;">10. КОНТАКТЫ ОПЕРАТОРА</h3>
    <p>— Индивидуальный предприниматель: Макаревич Вероника Александровна<br>
    — ИНН: 781407988795<br>
    — Email: veranikamakarevich@yandex.ru<br>
    — MAX-канал: https://max.ru/id781407988795_biz</p>

    <h3 style="color:#B5FF47;">11. ИЗМЕНЕНИЕ ПОЛИТИКИ</h3>
