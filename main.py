...
<style>
    ...
    @media (max-width: 700px) {
        .apple-hero h1 { font-size: 1.5rem; white-space: normal; }
...
<div class="apple-hero">
    <h1>Вы эксперт, а клиентов нет?</h1>
    <p class="subtitle">
        AI-аналитик от продюсера экспертов покажет, где вы теряете деньги, и даст план под вашу нишу — за 2 минуты.
    </p>
...
<div class="glass-card" style="max-width:700px; margin:40px auto; text-align:left;">
    ...
    <ul class="apple-list" style="margin-top:16px;">
        <li>Ты эксперт, коуч, психолог или владелец онлайн-школы.</li>
        <li>У тебя уже есть клиенты, но хочешь больше и стабильнее.</li>
        <li>Ты только начинаешь и не знаешь, куда бить.</li>
        <li>Ты сливаешь бюджет на рекламу, а она не окупается.</li>
    </ul>
    <p style="color:#AAB2C0; margin-top:12px; font-size:0.95rem;">Хотя бы один пункт — мой план для тебя.</p>
</div>

<!-- БЛОК "Развею ваши сомнения" (заменён заголовок) -->
