...
<div class="form-card" style="text-align: center;">
    <div style="background: #e8f0fe; border-radius: 20px; padding: 20px; margin: 20px 0; text-align: left;">
        <p style="font-size: 16px; font-weight: 500;">🎉 Доступ к пакету «Внедрение — я сам» активирован!</p>
        <p style="font-size: 14px; margin-top: 10px;">Ваш маркетинговый план уже сгенерирован и ждёт вас в чат-боте.</p>
    </div>
    <hr style="margin: 32px 0;">
    <div class="bot-link-block">
        ...
        <div class="bot-text">
            ...
            <p>Чтобы начать внедрять маркетинговый план, перейдите в чат и напишите <strong>/start</strong>.</p>
        </div>
...
... (оставлен текст оферты, без изменений) ...
"""
    # Для краткости оставляем как есть, но в реальном коде здесь полная оферта
    oferta_html = f"""
<div class="container">
